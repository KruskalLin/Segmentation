...
def plotPrecisionRecall(precision, recall, outFileName, Fig=None, drawCol=1, textLabel=None, title=None, fontsize1=24,
...
def saveBEVImageWithAxes(data, outputname, cmap=None, xlabel='x [m]', ylabel='z [m]', rangeX=[-10, 10], rangeXpx=None,
                         numDeltaX=5, rangeZ=[7, 62], rangeZpx=None, numDeltaZ=5, fontSize=16):
    '''
...
def modBev_plot(ax, rangeX=[-10, 10], rangeXpx=[0, 400], numDeltaX=5, rangeZ=[8, 48], rangeZpx=[0, 800], numDeltaZ=9,
                fontSize=None, xlabel='x [m]', ylabel='z [m]'):
    '''
